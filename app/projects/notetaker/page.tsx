...
export default function Home() {
    return (
      <main className="mx-auto max-w-3xl px-4 sm:px-6 md:max-w-5xl ">
        ...
        <ProjectDescription 
        header="The Question"
        text="How can we help students learn from audio/video lectures without fatiguing them from watching for several hours?"
        text2=""
        />
        <ProjectDescription 
        header="Our Solution"
